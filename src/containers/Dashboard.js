...
export default class {
  ...
  handleEditTicket(e, bill, bills) {
    ...
    switch (bill.status) {
      case "pending":
        validState = "Facture en attente de validation 🟠";
        break;
      case "accepted":
        validState = "Facture validée ✅";
        break;
      case "refused":
        validState = "Facture refusée ❌";
        break;
    }
    this.document.getElementById("status").innerHTML = `${validState}`;
